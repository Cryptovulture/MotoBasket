...
import { MOTO_DECIMALS } from '../config/contracts';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {!loading && baskets.length === 0 && (
        <div className="text-center py-20">
          <p className="text-dark-400 text-lg mb-4">No indexes available yet.</p>
      ...
      {!loading && baskets.length > 0 && (
        <div className="space-y-4">
          {baskets.filter(b => b.active !== 0n).map(basket => (
            <Link
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-display font-bold text-white">{basket.name}</h3>
